...
def mostrar_guia_instalacion():
    ...
    with tab_android:
        st.markdown("<ol style='color: #5D4037; font-size: 16px; line-height: 1.8;'><li>Abrí esta página en <b>Google Chrome</b>.</li><li>Tocá los <b>tres puntitos (⋮)</b> arriba a la derecha.</li><li>Elegí la opción <b>'Agregar a la pantalla principal'</b> o <b>'Instalar aplicación'</b>.</li><li>¡Listo! Vas a ver la huellita de Peluditos junto a tus otras apps.</li></ol>", unsafe_allow_html=True)
    with tab_apple:
        st.markdown("<ol style='color: #5D4037; font-size: 16px; line-height: 1.8;'><li>Abrí esta página en <b>Safari</b>.</li><li>Tocá el ícono de <b>Compartir</b> (el cuadradito con la flecha hacia arriba 📤) en la barra de abajo.</li><li>Bajá un poco y elegí <b>'Agregar a Inicio'</b>.</li><li>¡Listo! La huellita ya está en tu teléfono.</li></ol>", unsafe_allow_html=True)
...
def mostrar_menu_principal():
    ...
    # --- REDES Y COMPARTIR (ACÁ ESTÁ EL BOTÓN DE DESCARGA NUEVO) ---
    ...
    <a href="{link_whatsapp}" target="_blank" style="text-decoration: none;">
        <div style="background-color: #25D366; color: white; padding: 12px; border-radius: 20px; text-align: center; font-weight: bold; margin-bottom: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); font-family: 'Nunito', sans-serif;">
            <span style="font-size: 18px;">💬</span> Compartir link en WhatsApp
        </div>
    </a>
    """
    st.markdown(boton_wa, unsafe_allow_html=True)

    # El botón que le baja la imagen automáticamente al vecino
    if os.path.exists("afichePR.jpg"):
        with open("afichePR.jpg", "rb") as f:
            st.download_button(
                label="📥 Bajar imagen para compartir o poner en tu estado",
                data=f,
                file_name="Peluditos_en_Red.jpg",
                mime="image/jpeg",
...
# ==========================================
# 5. EL DIRECTOR DE TRÁNSITO (MECÁNICA DE NAVEGACIÓN - CON AUDIO)
# ==========================================
components.html(
    """
    <script>
        setTimeout(function() {
            ...
            videos.forEach(function(vid) {
                // Sin vid.muted = true para permitir el audio
...
# ==========================================
# 6. SECCIÓN SOLIDARIA PERMANENTE (RESTAURADA)
# ==========================================
if st.session_state.vista != 'menu':
    st.markdown("---")
